...
│   │   ├── mode2_prompt_sweep.csv        # Full system sweep (Sys1–4 × all prompts)
│   │   └── iteration_log.csv            # Per-iteration convergence log
│   ├── enrichment/
...
│       └── permutation_aucs_mode1_tp4.csv
│
├── figures/
│   ├── permutation_test.png              # Mode 2: real AUC 0.902 vs null distribution
...
│   ├── mode1_scaling.png                 # F1 vs deletion rate, precision/recall decomposition
